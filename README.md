...
|---|---|
| Headline, about text, any wording | `index.html` (all plain text between tags) |
...
The form currently opens the visitor's email app with the message pre-filled, so it works with no server. To have messages delivered straight to your inbox instead:

1. Sign up free at [formspree.io](https://formspree.io) and create a form and you'll get a URL like `https://formspree.io/f/abcd1234`.
